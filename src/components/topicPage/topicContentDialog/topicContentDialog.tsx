...
interface topicFormProps {
  ...
  onRequestClose: () => void;
  topicId: string;
  handleThreadReplyClick: (displayName: string, threadId: string) => void;
}
        ...
        <div id="topic-page">
          ...
          <div className="px-10 py-16 flex">
            <div id="topic-content" className="w-3/5 px-10 py-8 rounded-xl">
              <p id="topic-title" className="text-3xl font-semibold text-white">
            ...
            <div className="w-full ml-16">
              {topicData && (
                <ThreadBox
                  topicId={topicId}
                  handleReplyClick={handleThreadReplyClick}
                />
              )}
            </div>
          </div>
